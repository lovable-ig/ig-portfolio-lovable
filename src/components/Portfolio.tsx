    ...
    <section id="portfolio" className="min-h-screen py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-800 ${
          ...
          <button className="group bg-white bg-opacity-5 border border-white border-opacity-20 px-8 py-3 rounded-full hover:bg-opacity-10 transition-all duration-300 backdrop-blur-sm">
