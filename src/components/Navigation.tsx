  ...
  `}
              ...
              >
                {isDark ? (
                  <Sun
                    size={16}
                    className="group-hover:text-black text-white transition-colors duration-300"
                  />
                ) : (
                  <Moon
                    size={16}
                    className="group-hover:text-white text-black transition-colors duration-300"
                  />
                )}
              </button>
      ...
      <div
        className={`fixed inset-0 z-40 bg-background bg-opacity-95 backdrop-blur-sm transition-opacity duration-300 md:hidden ${
          isOpen
